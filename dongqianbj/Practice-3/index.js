...
const { TONG, TIAO, WAN, ZI, FLOWER } = require('./constant.js')
 ...
 */
function removeQQ(_Qs, _arr, result) {
...
function removePPP(_Ps, _arr) {
  ...
  if (Ps.length) {
    ...
    removed = removeNCard(arr, 3, P)

    return removePPP(Ps, removed)
